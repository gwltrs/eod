...
indicatorTests = suite "Indicator" do
  ...
  test "bullishReverse" do

    Assert.equal false (bullishReverse [1, 1, 1])
    Assert.equal true (bullishReverse [1, 1, 2])
    Assert.equal true (bullishReverse [1, 1, 3])
    Assert.equal false (bullishReverse [1, 2, 1])
    Assert.equal false (bullishReverse [1, 2, 2])
    Assert.equal false (bullishReverse [1, 2, 3])
    Assert.equal false (bullishReverse [1, 3, 1])
    Assert.equal false (bullishReverse [1, 3, 2])
    Assert.equal false (bullishReverse [1, 3, 3])
    Assert.equal false (bullishReverse [2, 1, 1])
    Assert.equal true (bullishReverse [2, 1, 2])
    Assert.equal true (bullishReverse [2, 1, 3])
    Assert.equal false (bullishReverse [2, 2, 1])
    Assert.equal false (bullishReverse [2, 2, 2])
    Assert.equal true (bullishReverse [2, 2, 3])
    Assert.equal false (bullishReverse [2, 3, 1])
    Assert.equal false (bullishReverse [2, 3, 2])
    Assert.equal false (bullishReverse [2, 3, 3])
    Assert.equal false (bullishReverse [3, 1, 1])
    Assert.equal true (bullishReverse [3, 1, 2])
    Assert.equal true (bullishReverse [3, 1, 3])
    Assert.equal false (bullishReverse [3, 2, 1])
    Assert.equal false (bullishReverse [3, 2, 2])
    Assert.equal true (bullishReverse [3, 2, 3])
    Assert.equal false (bullishReverse [3, 3, 1])
    Assert.equal false (bullishReverse [3, 3, 2])
    Assert.equal false (bullishReverse [3, 3, 3])

    Assert.equal false (bullishReverse [0, 1, 1, 1])
    Assert.equal true (bullishReverse [1, 1, 1, 2])
    Assert.equal true (bullishReverse [2, 1, 1, 3])
    Assert.equal false (bullishReverse [3, 1, 2, 1])
    Assert.equal false (bullishReverse [4, 1, 2, 2])
    Assert.equal false (bullishReverse [0, 0, 1, 2, 3])
    Assert.equal false (bullishReverse [1, 1, 1, 3, 1])
    Assert.equal false (bullishReverse [2, 2, 1, 3, 2])
    Assert.equal false (bullishReverse [3, 3, 1, 3, 3])
    Assert.equal false (bullishReverse [4, 4, 2, 1, 1])
    Assert.equal true (bullishReverse [0, 0, 2, 1, 2])
    Assert.equal true (bullishReverse [1, 1, 2, 1, 3])
    Assert.equal false (bullishReverse [2, 2, 2, 2, 1])
    Assert.equal false (bullishReverse [3, 3, 2, 2, 2])
    Assert.equal true (bullishReverse [4, 4, 2, 2, 3])
    Assert.equal false (bullishReverse [0, 0, 0, 2, 3, 1])
    Assert.equal false (bullishReverse [1, 1, 1, 2, 3, 2])
    Assert.equal false (bullishReverse [2, 2, 2, 2, 3, 3])
    Assert.equal false (bullishReverse [3, 3, 3, 3, 1, 1])
    Assert.equal true (bullishReverse [4, 4, 4, 3, 1, 2])
    Assert.equal true (bullishReverse [0, 3, 1, 3])
    Assert.equal false (bullishReverse [1, 3, 2, 1])
    Assert.equal false (bullishReverse [2, 3, 2, 2])
    Assert.equal true (bullishReverse [3, 3, 2, 3])
    Assert.equal false (bullishReverse [4, 3, 3, 1])
    Assert.equal false (bullishReverse [5, 3, 3, 2])
